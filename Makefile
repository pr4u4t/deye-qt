...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_SERIALBUS_LIB -DQT_NETWORK_LIB -DQT_SERIALPORT_LIB -DQT_CORE_LIB
CFLAGS        = -pipe -O2 -Wall -Wextra -D_REENTRANT $(DEFINES)
CXXFLAGS      = -pipe -O2 -Wall -Wextra -D_REENTRANT $(DEFINES)
INCPATH       = -I. -I. -I/usr/include/qt6 -I/usr/include/qt6/QtGui -I/usr/include/qt6/QtSerialBus -I/usr/include/qt6/QtNetwork -I/usr/include/qt6/QtSerialPort -I/usr/include/qt6/QtCore -I. -I/usr/lib/qt6/mkspecs/linux-g++
...
LIBS          = $(SUBLIBS) /usr/lib/libQt6Gui.so /usr/lib/libGLESv2.so /usr/lib/libEGL.so /usr/lib/libQt6SerialBus.so /usr/lib/libQt6Network.so /usr/lib/libQt6SerialPort.so /usr/lib/libQt6Core.so -lpthread -lGLESv2 -lEGL   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
